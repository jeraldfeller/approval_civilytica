...
class RandwickTask extends _BaseTask {

    public $council_name = "Randwick";
    public $council_website_url = "https://www.randwick.nsw.gov.au";
    ...
    public function scrapeAction($params = []) {
        ...
        $url = "http://planning.randwick.nsw.gov.au/Pages/XC.Track.Advanced/SearchApplication.aspx"
                . "?d=last14days"
                . "&k=LodgementDate"
                . "&t=217"
                . "&o=xml";
        ...
        foreach ($daApplications as $daApplication) {
            ...
            $daCouncilUrl = "http://planning.randwick.nsw.gov.au/Pages/XC.Track.Advanced/SearchApplication.aspx?id=" . $daCouncilReferenceAlt;
    ...
    protected function extractDocuments($html, $da, $params = null): bool {
        ...
        if ($errno !== 0) {
            $this->logger->error("cURL error when fetching documents: {errmsg} ({errno})", [
                "errmsg" => $errmsg,
                "errno" => $errno
            ]);
            return false;
